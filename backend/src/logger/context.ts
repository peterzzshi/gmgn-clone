...
export class LogContext {
  ...
  static create(
    category: string,
    data: Omit<Partial<LogContextData>, 'category'> = {},
  ): LogContext {
  ...
  withCategory(category: string): LogContext {
...
const EMPTY_CONTEXT = LogContext.create('unknown');

const asyncLocalStorage = new AsyncLocalStorage<LogContext>();

export const getLogContext = (): LogContext => asyncLocalStorage.getStore() ?? EMPTY_CONTEXT;
